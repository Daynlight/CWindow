...
CW::Renderer::Texture &CW::Renderer::Texture::operator=(const Texture &second) noexcept{
...
CW::Renderer::Texture &CW::Renderer::Texture::operator=(Texture &&second) noexcept{
  if(this == &second) return *this;
